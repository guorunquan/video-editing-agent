...
本项目是学习向的 **v1.5**：CLI Agent + 本地 Web 体验站（AI 视频理解、证据化剪辑建议、确认计划、成片管理、多会话记录）。设计思路参考 [OpenChatCut](https://github.com/0xsline/OpenChatCut)，但刻意做成学生可维护的迷你工具，而不是完整剪辑器。
...
| **[HANDOFF.md](./HANDOFF.md)** | **下一个 Agent / 开发者**：架构、约定、v1.5 方向 |
