...
本项目当前为学习向的 **v1.7**：CLI Agent + 本地 Web 体验站（AI 视频理解、证据化剪辑建议、简体自动字幕、批量字幕替换、固定水印处理、确认计划、成片管理）。设计思路参考 [OpenChatCut](https://github.com/0xsline/OpenChatCut)，但刻意做成学生可维护的迷你工具，而不是完整剪辑器。
