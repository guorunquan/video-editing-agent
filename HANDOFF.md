...
面向：**下一个接手本仓库的 AI Agent 或人类开发者**（准备做 v1.0 / v1.5）。  
...
截至文档编写时，主线能力在 **v0.5 + 后续未打 tag 的体验增强**（以 `CHANGELOG.md` 的 Unreleased / 最新节为准）：
...
当前请根据用户指定的目标（如 v1.0）小步提交，并同步更新 CHANGELOG / USAGE / PROBLEMS。
```
